...
const JobListing = () => {
    ...
    useEffect(() => {
        ...
        const matchesLocation = job =>
            selectedLocations.length === 0 || selectedLocations.includes(job.location); // fixed
    ...
    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
            ...
            <div className='w-full lg:w-1/4 bg-white px-4'>
                ...
                <button onClick={e => setShowFilter(prev => !prev)} className='px-5 py-1.5 rounded border border-gray-400 lg:hidden'>
